...
public class ApiExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> customerInactiveException(RuntimeException ex, HttpServletRequest request) {
        return ResponseEntity
    ...
    public ResponseEntity<ErrorMessage> handleErroComunicacaoMicroservices(ErrorMicroServiceComunicationException ex, HttpServletRequest request) {
        return ResponseEntity
                .status(ex.getStatus())
                .contentType(MediaType.APPLICATION_JSON)
